          ...
          <div class="sidebar col-md-3 col-sm-5">
            <ul class="list-group margin-bottom-25 sidebar-menu">
              ...
              <li class="list-group-item clearfix dropdown active">
                <a href="shop-product-list.php" class="collapsed">
                  <i class="fa fa-angle-right"></i>
                  Mens
                ...
                <ul class="dropdown-menu" style="display:block;">
                  <li class="list-group-item dropdown clearfix active">
                    <a href="shop-product-list.php" class="collapsed"><i class="fa fa-angle-right"></i> Shoes </a>
                      <ul class="dropdown-menu" style="display:block;">
                        ...
                        <li class="list-group-item dropdown clearfix active">
                          <a href="shop-product-list.php" class="collapsed"><i class="fa fa-angle-right"></i> Sport  </a>
                          <ul class="dropdown-menu" style="display:block;">
                ...
                <div class="product-page-content">
                  ...
                  <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="Reviews">
                      ...
                      <!-- BEGIN FORM-->
                      <form action="form-submit.php" class="reviews-form" role="form" method="post">
